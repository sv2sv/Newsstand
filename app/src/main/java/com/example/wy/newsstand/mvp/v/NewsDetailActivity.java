...
import com.example.wy.newsstand.weight.URLImageGetter;
 ...
 */
public class NewsDetailActivity extends NSActivity implements NewsDetailView {
    ...
    public void setNewsDetail(NewsDetail newsDetail) {
        ...
        String newsTime = WYNSDepend.formatDate(newsDetail.getPtime());
...
//              mNewsDetailBodyTv.setMovementMethod(LinkMovementMethod.getInstance());//加这句才能让里面的超链接生效,实测经常卡机崩溃
    ...
    private boolean isShowBody(String newsBody, int imgTotal) {
        return WYNSDepend.isHavePhoto() && imgTotal >= 2 && newsBody != null;
    }
    ...
    private void cancelUrlImageGetterSubscription() {
        try {
            if (mUrlImageGetter != null && mUrlImageGetter.mSubscription != null
                ...
                Log.d("cancelURlIGSubscription","UrlImageGetter unsubscribe");
            }
        } catch (Exception e) {
            Log.e("cancelURlIGSubscription","取消UrlImageGetter Subscription 出现异常： " + e.toString());
        }
    }
